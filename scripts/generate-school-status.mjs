...
const VERIFIED_REASONS = {
  ...
  // 서울 강남구 (2026-05-02 사용자 확인)
  seoul_daecheong: '미업로드 (사용자 확인 2026-05-02)',
  seoul_bongeun: '미업로드 (사용자 확인 2026-05-02)',
  seoul_yulhyeon:
    '외부 뷰어 사용 (사용자 확인 2026-05-02 — viewhosting.ssem.or.kr blob URL, 현행 sen-es scraper 미지원, 별도 조사 TODO)',
};
